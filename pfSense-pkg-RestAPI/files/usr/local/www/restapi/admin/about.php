...
$pgtitle = array(gettext('System'), gettext('RestAPI'), gettext('About'));
...
$tab_array[] = array(gettext("About"), true, "/restapi/admin/about.php");
...
events.push(function() {
    ...
    $('.phpExample').css('background-color', '#2e2e2e');
})
//]]>
</script>
