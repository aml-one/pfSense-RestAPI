...
$pgtitle = array(gettext('System'), gettext('RestAPI'), gettext('Logs'));
include_once('head.inc');


$tab_array   = array();
$tab_array[] = array(gettext("Credentials"), false, "/restapi/admin/credentials.php");
$tab_array[] = array(gettext("Logs"), true, "/restapi/admin/logs.php");
...
$logs = conv_log_filter(
    ...
    array("message" => "restapi")
);
?>

<div class="panel panel-default">
    <div class="panel-heading">
        <h2 class="panel-title">RestAPI Logs</h2>
    </div>
